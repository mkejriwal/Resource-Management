           ...
           <%
        	...
        	if(session.getAttribute("Consname")==null)
              ...
              try{
               ...
               ResultSet rs=null;
               String s1="select b.bID,b.fromDate,b.toDate,b.bQty,r.rName,o.oName,b.status from booking b,resource r,owner o where r.rID=b.rID and r.oID=o.oID and b.cID='"+user+"';";
